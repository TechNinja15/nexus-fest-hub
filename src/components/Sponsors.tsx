  ...
  const sponsorTiers = [
    ...
    },
    {
      ...
      sponsors: [
        ...
        { name: "AUTOMOBILE PARTNER", logo: "DS" },
        { name: "BANKING PARTNER", logo: "CV" },
        { name: "RADIO PARTNER", logo: "DC" },
        { name: "TRAVELING PARTNER", logo: "TM" },
        { name: "SUPPORTING PARTNER", logo: "CA" },
        { name: "TECH PARTNER", logo: "DS" },
        { name: "COSTUME PARTNER", logo: "CV" },
      ],
    },
  ];
